...
```bash
wget https://github.com/amadvance/snapraid/releases/download/v14.8/snapraid-14.8.tar.gz
tar xzvf snapraid-14.8.tar.gz
cd snapraid-14.8
./configure
make -j"$(nproc)"
make check
...
```bash
wget https://github.com/amadvance/snapraid-daemon/releases/download/v1.13/snapraid-daemon-1.13.tar.gz
tar xzvf snapraid-daemon-1.13.tar.gz
cd snapraid-daemon-1.13/
./configure
make -j"$(nproc)"
make check
make install
cd ..
rm -rf snapraid-daemon-1.13*
