...
```bash
wget https://github.com/amadvance/snapraid/releases/download/v14.1/snapraid-14.2.tar.gz
tar xzvf snapraid-14.2.tar.gz
cd snapraid-14.2
./configure
make -j"$(nproc)"
make check
...
```bash
wget https://github.com/amadvance/snapraid-daemon/releases/download/v1.5/snapraid-daemon-1.6.tar.gz
tar xzvf snapraid-daemon-1.6.tar.gz
cd snapraid-daemon-1.6/
./configure
make -j"$(nproc)"
make check
make install
cd ..
rm -rf snapraid-daemon-1.6*
