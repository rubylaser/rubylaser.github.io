...
```bash
wget https://github.com/amadvance/snapraid/releases/download/v14.7/snapraid-14.7.tar.gz
tar xzvf snapraid-14.7.tar.gz
cd snapraid-14.7
./configure
make -j"$(nproc)"
make check
...
```bash
wget https://github.com/amadvance/snapraid-daemon/releases/download/v1.12/snapraid-daemon-1.12.tar.gz
tar xzvf snapraid-daemon-1.12.tar.gz
cd snapraid-daemon-1.12/
./configure
make -j"$(nproc)"
make check
make install
cd ..
rm -rf snapraid-daemon-1.12*
