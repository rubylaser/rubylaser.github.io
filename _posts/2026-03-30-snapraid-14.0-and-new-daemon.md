...
```bash
wget https://github.com/amadvance/snapraid/releases/download/v14.9/snapraid-14.9.tar.gz
tar xzvf snapraid-14.9.tar.gz
cd snapraid-14.9
./configure
make -j"$(nproc)"
make check
...
```bash
wget https://github.com/amadvance/snapraid-daemon/releases/download/v1.14/snapraid-daemon-1.14.tar.gz
tar xzvf snapraid-daemon-1.14.tar.gz
cd snapraid-daemon-1.14/
./configure
make -j"$(nproc)"
make check
make install
cd ..
rm -rf snapraid-daemon-1.14*
