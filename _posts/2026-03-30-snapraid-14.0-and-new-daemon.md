...
```bash
wget https://github.com/amadvance/snapraid/releases/download/v14.5/snapraid-14.5.tar.gz
tar xzvf snapraid-14.5.tar.gz
cd snapraid-14.5
./configure
make -j"$(nproc)"
make check
...
```bash
wget https://github.com/amadvance/snapraid-daemon/releases/download/v1.10/snapraid-daemon-1.10.tar.gz
tar xzvf snapraid-daemon-1.10.tar.gz
cd snapraid-daemon-1.10/
./configure
make -j"$(nproc)"
make check
make install
cd ..
rm -rf snapraid-daemon-1.10*
